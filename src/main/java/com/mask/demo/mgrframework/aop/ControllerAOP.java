package com.mask.demo.mgrframework.aop;
...
import com.mask.demo.mgrframework.utils.IPUtil;
...
public class ControllerAOP {
	 ...
	 * */
	@Pointcut("execution(public com.mask.demo.mgrframework.beans.response.IResult *(..))")
	public void resultPtCut() {}

	/**
	 * 创建日志切点
	 * */
	@Pointcut("@annotation(com.mask.demo.mgrframework.annotation.BizOperLog)")
