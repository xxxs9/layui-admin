package com.mask.demo.frame.aop;
...
import com.mask.demo.frame.utils.IPUtil;
...
public class ControllerAOP {
	 ...
	 * */
	@Pointcut("execution(public com.mask.demo.frame.beans.response.IResult *(..))")
	public void resultPtCut() {}

	/**
	 * 创建日志切点
	 * */
	@Pointcut("@annotation(com.mask.demo.frame.annotation.BizOperLog)")
